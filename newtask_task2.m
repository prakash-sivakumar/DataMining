function[shuffledPcaMatrix] = newtask_task2(eatingAction,NoneatingAction)
    load("/Users/rohithreddyv/Desktop/Data Mining/Assignment4/Eating.mat")
    load("/Users/rohithreddyv/Desktop/Data Mining/Assignment4/Noneating.mat")
    Eating = Eating(29930:42930,5:end);
    NonEating = Noneating(29930:42930,5:end);
